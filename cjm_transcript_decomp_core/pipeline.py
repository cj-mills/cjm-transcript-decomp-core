...
# %% auto #0
__all__ = ['logger', 'submit_and_wait', 'load_source_manifest', 'analyze_segment_vad', 'align_segment', 'decompose_source',
           'confirm_seam', 'collect_plugin_info', 'run_decomp']
...
async def analyze_segment_vad(
    ...
    # Stage 2 (typed wire layer): a typed MediaAnalysisResult with TimeRange
    # ranges arrives at the host — the field_of tolerance (D10) retired.
...
async def align_segment(
    ...
    # Stage 2 (typed wire layer): a typed ForcedAlignResult with typed items
    # arrives at the host — the dict-or-object branches (D10) retired.
...
async def decompose_source(
    ...
    # plain dict access; these were never wire results.
