...
in the original text, assign words to VAD chunks by timestamp, and build one text segment
per VAD chunk. Extracted from the page-centric `ForcedAlignmentService` (Tier-1 logic).

Docs: https://cj-mills.github.io/cjm-transcript-decomp-corealignment.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/alignment.ipynb.

# %% auto #0
__all__ = ['map_fa_words_to_text', 'assign_words_to_chunks', 'build_segments_from_alignment', 'tier1_alignment_checks']

# %% ../nbs/alignment.ipynb #e67a4e4a
import re
from typing import List, Dict, Optional, Tuple

from .models import FAWord, VADChunk, TextSegment

# %% ../nbs/alignment.ipynb #fc27b533
